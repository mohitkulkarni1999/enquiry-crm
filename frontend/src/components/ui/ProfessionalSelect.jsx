...
const ProfessionalSelect = forwardRef(({ 
  ...
  const getSelectClasses = () => {
    let classes = `w-full rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 appearance-none ${sizes[size]} ${variants[variant]}`;
